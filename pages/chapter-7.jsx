...
export default function Chapter7() {
  ...
  const verses = [
    ...
    },
    {
      ...
      summary: "If lamplight illuminated itself and that of others, darkness too would without doubt obscure itself and the thing of others.",
      quantum: "Complementarity: Wave and particle aspects are complementary; observing one affects the other, like light and darkness roles."
    },
    {
      number: 13,
      title: "Self-Birth Paradox",
      summary: "How can unborn birth give birth to itself? If the born gives birth, when it has been born, what would be born?",
      quantum: "Bootstrapping in Quantum Field Theory: Particles can be their own antiparticles, like birth giving birth to itself."
    },
    {
      number: 14,
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Chapter 7: Investigation of Birth, Abiding and Perishing - Nāgārjuna's Quantum Reflections</title>
        <meta name="description" content="Chapter 7 of Mūlamadhyamakakārikā examining birth, abiding and perishing through Madhyamaka and quantum physics" />
        ...
        <section className={styles.summary}>
          <div className={styles.summaryContent}>
            ...
            <div className={styles.chapterAction}>
              <a href="/Ch7 (1:3)/index.html" className={styles.visualizeButton}>
                View Interactive Animations (Part 1)
              </a>
              <a href="/Ch7 (2:3)/index.html" className={styles.visualizeButton}>
                View Interactive Animations (Part 2)
              </a>
              <a href="/Ch7 (3:3)/index.html" className={styles.visualizeButton}>
              ...
              <div key={verse.number} className={styles.verseCard}>
                ...
                <div className={styles.verseContent}>
                  ...
                  <div className={styles.verseLinks}>
                    {verse.number <= 12 && (
                      <Link href={`/Ch7 (1:3)/index.html#verse-${verse.number}`}>
                        View in Part 1
                      </Link>
                    )}
                    {verse.number > 12 && verse.number <= 24 && (
                      <Link href={`/Ch7 (2:3)/index.html#verse-${verse.number}`}>
                        View in Part 2
                      </Link>
                    )}
                    {verse.number > 24 && verse.number <= 34 && (
                      <Link href={`/Ch7 (3:3)/index.html#verse-${verse.number}`}>
                        View in Part 3
                      </Link>
                    )}
                  </div>
