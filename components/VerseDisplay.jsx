...
import VerseCanvas from './animations/VerseCanvas';
...
const VerseDisplay = ({ 
  ...
  // Determine if we should use the new Three.js animation
  const useNewAnimation = chapter === "1" && parseInt(verse) <= 7;
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.animationContainer}>
        {useNewAnimation ? (
          // New Three.js animation for Chapter 1, verses 1-7
          <VerseCanvas 
            chapter={chapter}
            verse={verse}
          ...
          // Legacy FalAnimation for other chapters/verses
          <FalAnimation 
