...
export const WHOP_PRODUCTS = {
  [TIERS.SEEKER]: process.env.NEXT_PUBLIC_WHOP_SEEKER_PRODUCT_ID || 'prod_seeker',
  [TIERS.PRACTITIONER]: process.env.NEXT_PUBLIC_WHOP_PRACTITIONER_PRODUCT_ID || 'prod_practitioner',
  [TIERS.TEACHER]: process.env.NEXT_PUBLIC_WHOP_TEACHER_PRODUCT_ID || 'prod_teacher'
};
