    ...
    setupVerse6Animation() {
        const animation = {
            ...
            createParticles: () => {
                ...
                function createFluctuatingParticle(size, opacity, color) {
    ...
    setupVerse8Animation() {
        const animation = {
            ...
            initialize: () => {
                ...
                // Add time markers
                const pastMarker = createTimeMarker("Past", -3);
                const presentMarker = createTimeMarker("Present", 0);
                const futureMarker = createTimeMarker("Future", 3);
                ...
                // Create "cause" and "effect" zones
                createZone("Conditions/Cause", -2, 0x7209b7);
                createZone("Effect/Fruit", 2, 0xffd100);
                ...
                function createTimeMarker(text, position) {
                    const canvas = document.createElement('canvas');
                    canvas.width = 128;
                    canvas.height = 64;
                    const context = canvas.getContext('2d');
                    ...
                    const line = new THREE.Line(lineGeometry, lineMaterial);
                    animation.scene.add(line);
                    
                    return sprite;
                }
                
                // Helper function to create zones
                function createZone(text, position, color) {
    ...
    setupVerse12Animation() {
        const animation = {
            ...
            initialize: () => {
                ...
                // Add time markers
                const pastMarker = createTimeMarker("Past", -4, -2);
                const presentMarker = createTimeMarker("Present", 0, -2);
                const futureMarker = createTimeMarker("Future", 4, -2);
                ...
                function createTimeMarker(text, x, y) {
                    const canvas = document.createElement('canvas');
                    canvas.width = 128;
                    canvas.height = 64;
                    const context = canvas.getContext('2d');
